...
export class Config {
  ...
  public static readonly POSTGRESQL_ADDON_USER: string = process.env.POSTGRESQL_ADDON_USER || 'dlacreme';
  public static readonly POSTGRESQL_ADDON_PASSWORD: string = process.env.POSTGRESQL_ADDON_PASSWORD || '';
